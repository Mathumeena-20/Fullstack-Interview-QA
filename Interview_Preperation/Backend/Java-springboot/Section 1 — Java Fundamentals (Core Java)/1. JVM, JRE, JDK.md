Here’s a clear, interview-friendly explanation of **JVM, JRE, JDK and JVM internals**, with simple examples.

---

## 1. Difference between JVM, JRE, and JDK

Here’s the same **interview-style “method answer”** format for **JDK, JRE and JVM** like in your screenshot:
...
| **JVM**   | Java Virtual Machine     | Used to **execute** Java bytecode                         | Converts bytecode → Machine code & manages memory, GC, threads   |
...
3. **Application ClassLoader** – loads classpath classes
...
* **Interpreter** – reads & executes line by line
* **JIT Compiler** – compiles frequently used code to machine code
...
3. Survives multiple GC → Old Gen
...
* Converts Java source code → Bytecode (`.class` file)
