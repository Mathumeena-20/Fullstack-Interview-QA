Below is a **clean, interview-ready explanation** of **Factory Design Pattern** with examples, UML, comparisons, testing approaches, and real-world use cases.
...
✔ Adds flexibility and maintainability
...
| Example    | ShapeFactory → Shape           | GUIFactory → Button, Checkbox            |
...
# ✅ **3. What problem does the Factory pattern solve?**

Factory solves:

### ✔ Problem 1 — Avoiding tight coupling

Client doesn’t use `new` keyword → creation logic is hidden.

### ✔ Problem 2 — Centralizing object creation

You can modify object creation **in one place**.

### ✔ Problem 3 — Conditional creation

Different objects based on input (e.g., `if-else` or subclass logic).

### ✔ Problem 4 — Simplifies maintenance
...
> “Factory solves the problem of complex object creation and decouples creation logic from business logic.”

---

# ✅ **4. How do you implement the Factory pattern in Java?**

Let’s build `ShapeFactory`.
...
* Factory → pick which class to instantiate
* Builder → construct object with many fields

---

# 🟢 Interview answer:

> “Factory decides *which* object to create; Builder decides *how* to create an object with many combinations.”
...
✔ When object creation depends on input/config
✔ When you want loose coupling
✔ When you want to support new products easily
✔ When you need multiple strategies

### Real project scenario (strong answer):

> “We used Factory Pattern for selecting different payment gateways (Stripe, PayPal, Razorpay) based on user input. The client code requested:
> `PaymentGateway gateway = PaymentFactory.getGateway(type);`
> and the factory decided which class to instantiate.”
...
> “Spring’s BeanFactory and FactoryBean are real-life implementations of Factory pattern.”

---

# ✅ **8. How Factory improves scalability?**

Factory isolates all creation logic → so adding a new product does NOT affect client code.

✔ Add new class → Just update factory or register it
✔ No client code changes
✔ No compile-time dependency on concrete classes
...
> “Factory improves scalability by letting us add new product types without changing client code, following OCP.”

---

# ✅ **9. UML design of Factory pattern**
...
### ✔ 3. Use interface return types to mock behavior
...
### ✔ 4. Use Dependency Injection instead of static factory
...
📄 **Factory + Builder combined example**
📦 **Real-world factory pattern used in payments, notifications, caching**
